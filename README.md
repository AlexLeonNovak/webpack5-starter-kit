...
```shell
git clone https://github.com/AlexLeonNovak/webpack5-starter-kit.git
```

Переименовать папку сборки именем вашего проекта.

```shell
mv webpack5-starter-kit имя_проекта
```
...
проекта в продакшен, после чего содержимое папки `dist` будет помещено в ветку
